            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <a href = "{{route('admin.category.edit',$category->id)}}" class = "btn btn-info wave-effects">
                        <i class = "material-icons">edit</i></a>


                        <button class = "btn btn-danger wave-effects" type = "button" onClick = "deleteCategory({{$category->id}})">  
