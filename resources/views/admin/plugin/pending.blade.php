...
@if($plugin->is_approved == false)
 <button type="button" class="btn btn-success wave-effect" onclick="approvePlugin({{ $plugin->id }})">
...
<span></span>
 ...
 @endif
             ...
             <a href="{{ route('admin.plugin.show',$plugin->id) }}" class="btn btn-info waves-effect">
                <i class="material-icons">visibility</i>
              </a>
                                         
              <a href="{{ route('admin.plugin.edit',$plugin->id) }}" class="btn btn-info waves-effect">
       ...
       <button class="btn btn-danger waves-effect" type="button" onclick="deletePlugin({{ $plugin->id }})">
              ...
              <form id="delete-form-{{ $plugin->id }}" action="{{ route('admin.plugin.destroy',$plugin->id) }}" method="POST" style="display: none;">
              	@csrf
              	@method('DELETE')
