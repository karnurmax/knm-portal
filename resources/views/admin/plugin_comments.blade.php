...
<div class="container-fluid">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                              ВСЕ КОММЕНТАРИИ 
                              <span class="badge bg-red">{{ $plugin_comments->count() }} </span>
                            </h2>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                @foreach($plugin_comments as $key=>$plugin_comment)
                                    	 <tr>
   ...
   <a target="/blank" href="{{ route('plugin.details',$plugin_comment->plugin->slug. '#plugin_comments') }}">Просмотреть в посте</a>
...
<div class="media-body">
 ...
 <button class="btn btn-danger waves-effect" type="button" onclick="deletePluginComment({{ $plugin_comment->id }})">
              ...
              <form id="delete-form-{{ $plugin_comment->id }}" action="{{ route('admin.plugin_comment.destroy',$plugin_comment->id) }}" method="POST" style="display: none;">
                @csrf
                @method('DELETE')
