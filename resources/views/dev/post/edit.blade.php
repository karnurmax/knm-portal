...
@section('content')
 <div class="container-fluid">
  ...
  <form action="{{ route('dev.post.update',$post->id) }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              @method('PUT')
            <!-- #END# Vertical Layout -->
...
<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
        ...
        <a class="btn btn-danger m-t-15 waves-effect" href="{{ route('dev.post.index') }} "> НАЗАД</a>                        
